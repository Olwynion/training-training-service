...
public class WorkoutPlanTests
{
    ...
    public void Hydrate_ShouldSetAllProperties()
    {
        ...
        var plan = WorkoutPlan.Hydrate(1, "user-1", "My Plan", 3, 2, createdAt);
    ...
    public void AddDay_ShouldAddPlanDay()
    {
        ...
        var day = PlanDay.Hydrate(1, "Chest Day", MuscleGroup.Chest, 1);
    ...
    {
        var day = PlanDay.Hydrate(1, "Leg Day", MuscleGroup.Legs, 2);

        Assert.Equal(1, day.Id);
    ...
    {
        var exercise = DayExercise.Hydrate(1, 1, "Squat", 4, 1);

        Assert.Equal(1, exercise.Id);
        Assert.Equal(1, exercise.ExerciseId);
